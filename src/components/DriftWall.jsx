...
const misImagenesLocales = [
  ...
  { image: imgTerapia3, title: 'Terapia 3' },
  { image: imgTerapia4, title: 'Terapia 4' },
  { image: imgTerapiaCabeza, title: 'Terapia de Cabeza' },
  { image: imgYoga2, title: 'Yoga 2' },
  { image: imgYogaGrupal, title: 'Yoga Grupal' },
  { image: imgEspacioGisel, title: 'Espacio Gisel' }
];

const DEFAULT_ITEMS = Array.from({ length: 15 }, (_, i) => {
  const item = misImagenesLocales[i % misImagenesLocales.length];
    ...
    if (item.href) {
      ...
      return (
        <a
          key={id}
          href={item.href}
          {...(!isInternalAnchor && { target: '_blank', rel: 'noreferrer noopener' })}
          {...commonProps}
        >
          {inner}
        </a>
